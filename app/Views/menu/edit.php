            ...
            <div class="card-body">
                <form action="<?= base_url('menu/update/' . $menu['id']) ?>" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= (session('errors.nama')) ? 'is-invalid' : '' ?>" id="nama" name="nama" value="<?= old('nama', $menu['nama']) ?>" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control <?= (session('errors.harga')) ? 'is-invalid' : '' ?>" id="harga" name="harga" value="<?= old('harga', $menu['harga']) ?>" min="0" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-emerald">Update Menu</button>
                    </div>
                </form>
            </div>
        </div>
